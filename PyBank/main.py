...
with open(csvpath) as budget:
    ...
    for row in csvreader: 
        ...
        # POTATO: Confirm I'm understanding "append" correctly
    ...
    for i in range(len(total_profit)-1):
        ...
        #POTATO - Math is not coming out ($25 and $45) | its right in Excel but uses average.
        average_change.append(total_profit[i+1]-total_profit[i])
        #i+1 = B27 minus i = B26


# What: Profit greatest increase and decrease
...
# What: Monthly greatest profit increase and decrease
...
# Notes: "w" for write | \n = hard return
# POTATO - output doesn't go to "analysis" folder. I created a string path at the start but couldn't get it to work.
# POTATO - Are the {} just placeholders with /n as hard returns for above lines? There are 7 lines and 7 sets of {} /n
...
line6 = str(f"Greatest Increase in Profits: {total_months[max_increase]} (${str(max_increase)})")
line7 = str(f"Greatest Decrease in Profits: {total_months[max_decrease]} (${str(max_decrease)})")
